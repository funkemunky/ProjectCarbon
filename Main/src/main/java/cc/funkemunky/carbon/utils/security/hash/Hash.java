...
import cc.funkemunky.carbon.exceptions.InvalidHashException;
import cc.funkemunky.carbon.utils.security.hash.impl.Argon;
import cc.funkemunky.carbon.utils.security.hash.impl.CRC16;
import cc.funkemunky.carbon.utils.security.hash.impl.SHA1;
import cc.funkemunky.carbon.utils.security.hash.impl.SHA2;
...
public abstract class Hash {
    ...
    public static void loadHashes() {
        Arrays.asList(new Argon(), new CRC16(), new SHA1(), new SHA2())
